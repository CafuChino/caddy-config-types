...
export type IStorage = INats | IFileStorage | IRedisStorage | IVaultStorage | ICaddyStorageGcs | IConsulStorage | IS3 | IEnvRedis | IPostgresStorage | IMysqlStorage;
...
export type IWriters = IDiscardWriter | IStderrWriter | IStdoutWriter | IFileWriter | INetWriter | IInfluxLog | IWriter | IGraphiteLog;
...
export type IEncoders = IAppendEncoder | IConsoleEncoder | IFilterEncoder | IJsonEncoder | ILogfmtEncoder | ISingleFieldEncoder | ICompat | ITransformEncoder | IElasticEncoder;
